    ...
    public class MainWindow : MonoBehaviour
    {
        ...
        public static bool optionToggle
        {
            ...
            set
            {
                ...
                else
                {
                    ...
                    Helper.SetCursorVisibleAndLockState(CursorVisible, lockMode);
                }
                if (!initialized)
                {
                    instance.CreateUI();
        ...
        private void CreateUI()
        {
            if (canvas == null)
            {
                ...
                {
                    UIWindows.AddToggle(ref point, "多倍拾取",BasicScripts, ScriptTrainer.ChangePick, (bool state) =>
                    {
                        PickInput?.SetActive(!state);
                    });
