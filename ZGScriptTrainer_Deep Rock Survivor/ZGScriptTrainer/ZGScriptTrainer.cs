...
namespace ZGScriptTrainer
{
    ...
    {
        public const string PLUGIN_GUID = "ScriptTrainer.Jim97.Deep_Rock_Survivor";

        public const string PLUGIN_NAME = "深岩银河：幸存者内置修改器";

        public const string PLUGIN_VERSION = "1.0.0";

        public const string PLUGIN_UPDATE_MODID = "208695";
...
#endif
    {
        ...
        public static ConfigEntry<Vector2[]> PanelPosition { get; set; }
        #endregion
        ...
        private void Init()
        {
            ...
            PanelPosition = Config.Bind("界面保存配置", "界面位置", Array.Empty<Vector2>());
            #endregion
