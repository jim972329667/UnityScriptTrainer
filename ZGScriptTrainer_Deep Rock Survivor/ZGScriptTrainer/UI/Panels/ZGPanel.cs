...
namespace ZGScriptTrainer.UI.Panels
{
    public abstract class ZGPanel : PanelBase
    {
        ...
        public abstract ZGUIManager.Panels PanelType { get; }
        ...
        public override void ConstructUI()
        {
            ...
            if (NavButtonWanted)
            {
                ...
                NavButton = UIFactory.CreateButton(ZGUIManager.NavbarTabButtonHolder, $"Button_{PanelType}", Name);
                ...
                NavButton.OnClick += () => { ZGUIManager.TogglePanel(PanelType); };
