...
{
    public static class ZGUIManager
    {
        public enum Panels
        {
            MainWindow,
        ...
        private static void CreateTopNavBar()
        {
            ...
            string titleTxt = $"{ZGBepInExInfo.PLUGIN_NAME}  by:jim97 <i><color=grey>{ZGBepInExInfo.PLUGIN_VERSION}</color></i>";
        ...
        {
            Title.text = $"{ZGBepInExInfo.PLUGIN_NAME}  by:jim97 <i><color=grey>{ZGBepInExInfo.PLUGIN_VERSION}</color></i> <i><color=red>需要更新</color></i>";
            Title.SetLayoutElement(minWidth: 75, flexibleWidth: 0);
