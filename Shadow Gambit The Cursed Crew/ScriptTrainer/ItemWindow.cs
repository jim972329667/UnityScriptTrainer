...
//            int num = 0;
//            foreach (ItemDataBase item in GetItemData())
//            {
//                var btn = CreateItemButton("获得", item, ItemPanel, () =>
//                {
//                    UIWindows.SpawnInputDialog(item.ItemName,"获得","1",(string text) =>
//                    {
...
//        private static GameObject CreateItemButton(string ButtonText, ItemDataBase item, GameObject panel, Action action)
//        {
//            //按钮宽 200 高 50
//            int buttonWidth = 190;
//            int buttonHeight = 50;
...
//        public static void SpawnItem(ItemDataBase item,int num)
//        {
//            EquipData equip = item.TryCast<EquipData>();
//            if (equip != null)
//            {
//                GameElement.addEquipByItem(equip.CreateRandomItem(Common.ItemQuality.legend, num));
//                Debug.Log($"成功添加装备{equip.ItemName}");
//            }
//            else
//            {
//                Debug.Log($"成功添加物品{item.ItemName}");
//                GameElement.addItemByItemData(item, num);
...
//        {
//            if (AllSceneSingleton<SaveManager>.Instance == null)
//            {
//                return false;
//            }
//            return true;
//        }
//        private static List<ItemDataBase> Items = new List<ItemDataBase>();
//        private static  void GetItems()
//        {
//            List<object> list1 = SearchProvider.UnityObjectSearch("", "ItemDataBase", ChildFilter.Any, SceneFilter.Any);

//            ScriptTrainer.WriteLog($"全物品数量=>{list1.Count}");
//            foreach (object obj in list1)
//            {
//                ItemDataBase item = obj.TryCast<ItemDataBase>();
//                if (item != null)
//                {
//                    Items.Add(item);
//                }
//            }
//        }
//        private static List<ItemDataBase> GetItemData()
//        {
//            List<ItemDataBase> ItemData = new List<ItemDataBase>();
//            if(Items.Count == 0)
//            {
//                GetItems();
//            }
...
//        }
//        //搜索过滤
//        private static List<ItemDataBase> FilterItemData(List<ItemDataBase> dataList)
//        {
//            if (searchText == "")
//            {
//                return dataList;
...
//            return list;
//        }
//        private static string GetItemName(ItemDataBase item)
//        {
//            return item.ItemName;
//        }
//        private static string GetItemDescription(ItemDataBase item)
//        {
//            CostItemData cost = item.TryCast<CostItemData>();
//            if (cost != null)
//            {
...
//            return item.describe;
//        }
//        private static Sprite GetItemIcon(ItemDataBase item)
//        {
//            return GlobalSettings.Instance.getItemIconByType(item.ItemClass);
//        }
//        #endregion
//    }
