...
namespace ScriptTrainer
{
    ...
    {
        #region[全局参数]
        public static RelicManager ZGRelicManager = null;
        ...
        public class GameInitOverridePatch_Start
        {
            [HarmonyPostfix]
            public static void Postfix(GameInit __instance)
            {
                ZGRelicManager = Traverse.Create(__instance).Field("_relicManager").GetValue<RelicManager>();
                //Debug.Log("泽哥：");
