...
namespace ScriptTrainer.Runtime
{
    public class Il2CppReflection : ReflectionUtility
    {
        ...
        internal override object Internal_TryCast(object obj, Type toType)
        {
            ...
            Il2CppObjectBase cppObj = obj as Il2CppObjectBase;

            if (obj is Il2CppObjectBase)
            {
                // from il2cpp objects...
        ...
        {
            return AccessTools.Method(structType, "BoxIl2CppObject", new Type[0])
                   .Invoke(cppStruct, new object[0])
        ...
        {
            string dir = Path.Combine(Paths.BepInExRootPath, "unhollowed");
        ...
        protected override bool Internal_TryGetDictEnumerator(object dictionary, out IEnumerator<DictionaryEntry> dictEnumerator)
        {
            ...
            try
            {
                ...
                Il2CppEnumerator keysEnumerator = new Il2CppEnumerator(keys, keys.GetActualType());
                Il2CppEnumerator valuesEnumerator = new Il2CppEnumerator(values, values.GetActualType());
