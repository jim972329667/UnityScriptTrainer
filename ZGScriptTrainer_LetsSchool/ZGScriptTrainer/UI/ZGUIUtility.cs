...
namespace ZGScriptTrainer.UI
{
    public static class ZGUIUtility
    {
        ...
        public static GameObject CreateGridScrollView(this GameObject parent, string name, Vector2 cellSize, out GameObject content, out AutoSliderScrollbar autoScrollbar,
            Color color = default)
        {
            ...
            content = UIFactory.CreateUIObject("Content", viewportObj);
